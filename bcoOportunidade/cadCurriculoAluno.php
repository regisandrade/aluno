...
$alunoDAO->pesquisar($bdBcoOportunidade,$param);
unset($param);
?>
...
<input type="hidden" name="idAluno" value="<?php echo ($registroCurriculo && $registroCurriculo->CPF != '' ? str_replace('.','',str_replace('-','',$registroCurriculo->CPF)) : str_replace('.','',str_replace('-','',$registroAluno->CPF))); ?>" />
    ...
    <div class="control-group">
		...
		<div class="controls">
			<input type="text" id="nome" name="nome" class="txtGrande" value="<?php echo ($registroCurriculo && $registroCurriculo->NOME != '') ? utf8_decode($registroCurriculo->NOME) : ($registroAluno && $registroAluno->Nome != '' ? utf8_decode($registroAluno->Nome) : ''); ?>" />
		</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<textarea id="endereco" name="endereco" class="txtGrande"><?php echo ($registroCurriculo && $registroCurriculo->ENDERECO != '') ? utf8_decode($registroCurriculo->ENDERECO) : ($registroAluno && $registroAluno->Endereco != '' ? utf8_decode($registroAluno->Endereco) : ''); ?></textarea></td>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="bairro" name="bairro" class="txtMedio" value="<?php echo ($registroCurriculo && $registroCurriculo->BAIRRO != '') ? utf8_decode($registroCurriculo->BAIRRO) : ($registroAluno && $registroAluno->Bairro != '' ? utf8_decode($registroAluno->Bairro) : ''); ?>" /></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="cidade" name="cidade" class="txtMedio" value="<?php echo ($registroCurriculo && $registroCurriculo->CIDADE != '') ? utf8_decode($registroCurriculo->CIDADE) : ($registroAluno && $registroAluno->Cidade != '' ? utf8_decode($registroAluno->Cidade) : ''); ?>" /></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="cep" name="cep" class="txtPequeno Mask" title="#####-###" maxlength="9" value="<?php echo ($registroCurriculo && $registroCurriculo->CEP != '') ? $registroCurriculo->CEP : ($registroAluno && $registroAluno->CEP !== '' ? $registroAluno->CEP : ''); ?>" />&nbsp;<span class="vermelho">9999-999</span></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="telefoneCelular" name="telefoneCelular" class="txtMedio Mask" title="(##) ####-####" maxlength="14" value="<?php echo ($registroCurriculo && $registroCurriculo->TELEFONE_CELULAR != '') ? $registroCurriculo->TELEFONE_CELULAR : ($registroAluno && $registroAluno->Celular !== '' ? $registroAluno->Celular : ''); ?>" />&nbsp;<span class="vermelho">(99) 9999-9999</span></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="email" name="email" class="txtGrande" value="<?php echo ($registroCurriculo && $registroCurriculo->EMAIL != '') ? $registroCurriculo->EMAIL : ($registroAluno && $registroAluno->e_Mail !== '' ? $registroAluno->e_Mail : ''); ?>" /></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="cidadeNascimento" name="cidadeNascimento" class="txtPequeno" value="<?php echo ($registroCurriculo && $registroCurriculo->CIDADE_NASCIMENTO != '') ? utf8_decode($registroCurriculo->CIDADE_NASCIMENTO) : ''; ?>" /></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
	        <select name="ufNascimento" id="ufNascimento" class="uf">
	            <option value="0">[Selecionar]</option>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="estadoCivil" name="estadoCivil" class="txtPequeno" value="<?php echo ($registroCurriculo && $registroCurriculo->ESTADO_CIVIL != '') ? $registroCurriculo->ESTADO_CIVIL : ''; ?>" /></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="rg" name="rg" class="txtPequeno" value="<?php echo ($registroCurriculo && $registroCurriculo->RG != '') ? $registroCurriculo->RG : ($registroAluno && $registroAluno->RG !== '' ? $registroAluno->RG : ''); ?>" /></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="orgaoExpedidor" name="orgaoExpedidor" class="txtPequeno" value="<?php echo ($registroCurriculo && $registroCurriculo->ORGAO_EXPEDIDOR != '') ? $registroCurriculo->ORGAO_EXPEDIDOR : ($registroAluno && $registroAluno->Orgao !== '' ? $registroAluno->Orgao : ''); ?>" /></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="dataExpedicaoRg" name="dataExpedicaoRg" class="txtPequeno" value="<?php echo ($registroCurriculo && $registroCurriculo->DATA_EXPEDICAO_RG != '') ? Util::formataData($registroCurriculo->DATA_EXPEDICAO_RG,'-','/') : ''; ?>" />&nbsp;<img src="../admin/bcoOportunidade/imagens/icone-calendario.png" class="imgCalendario" border="0"></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="carteiraReservista" name="carteiraReservista" class="txtPequeno" value="<?php echo ($registroCurriculo && $registroCurriculo->CARTEIRA_RESERVISTA != '') ? $registroCurriculo->CARTEIRA_RESERVISTA : ''; ?>" /></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        <input type="text" id="numeroPisPasep" name="numeroPisPasep" class="txtPequeno" value="<?php echo ($registroCurriculo && $registroCurriculo->PIS_PASEP != '') ? $registroCurriculo->PIS_PASEP : ''; ?>" /></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="numeroTituloEleitor" name="numeroTituloEleitor" class="txtPequeno" value="<?php echo ($registroCurriculo && $registroCurriculo->TITULO_ELEITOR != '') ? $registroCurriculo->TITULO_ELEITOR : ''; ?>" /></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="zona" name="zona" class="txtPequeno" value="<?php echo ($registroCurriculo && $registroCurriculo->ZONA != '') ? $registroCurriculo->ZONA : ''; ?>" /></td>
    	</div>
    </div>

    <div class="control-group">
        <label class="control-label" for="secao">Se&ccedil;&atilde;o:</label>
        	<input type="text" id="secao" name="secao" class="txtPequeno" value="<?php echo ($registroCurriculo && $registroCurriculo->SECAO != '') ? $registroCurriculo->SECAO : ''; ?>" /></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="numeroHabilitacao" name="numeroHabilitacao" class="txtPequeno" value="<?php echo ($registroCurriculo && $registroCurriculo->HABILITACAO != '') ? $registroCurriculo->HABILITACAO : ''; ?>" /></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="categoria" name="categoria" class="txtPequeno" value="<?php echo ($registroCurriculo && $registroCurriculo->CATEGORIA != '') ? $registroCurriculo->CATEGORIA : ''; ?>" /></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="vencimentoHabilitacao" name="vencimentoHabilitacao" maxlength="10" class="txtPequeno" value="<?php echo ($registroCurriculo && $registroCurriculo->VALIDADE != '') ? Util::formataData($registroCurriculo->VALIDADE,'-','/') : ''; ?>" />&nbsp;<img src="../admin/bcoOportunidade/imagens/icone-calendario.png" class="imgCalendario" border="0"></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<textarea id="areaInteresse" name="areaInteresse" class="txtGrande"><?php echo ($registroCurriculo && $registroCurriculo->AREA_INTERESSE != '') ? utf8_decode($registroCurriculo->AREA_INTERESSE) : ''; ?></textarea></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<textarea id="objetivoProfissional" name="objetivoProfissional" class="txtGrande"><?php echo ($registroCurriculo && $registroCurriculo->OBJETIVO_PROFISSIONAL != '') ? utf8_decode($registroCurriculo->OBJETIVO_PROFISSIONAL) : ''; ?></textarea></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
	        <select id="disponibilidadeHorario" name="disponibilidadeHorario">
	            <option value="">[Selecionar]</option>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="msn" name="msn" class="txtMedio" value="<?php echo ($registroCurriculo && $registroCurriculo->MSN != '') ? $registroCurriculo->MSN : ''; ?>" /></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="twitter" name="twitter" class="txtMedio" value="<?php echo ($registroCurriculo && $registroCurriculo->TWITTER != '') ? $registroCurriculo->TWITTER : ''; ?>" /></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="facebook" name="facebook" class="txtMedio" value="<?php echo ($registroCurriculo && $registroCurriculo->FACEBOOK != '') ? $registroCurriculo->FACEBOOK : ''; ?>" /></td>
    	</div>
    </div>

    <div class="control-group">
    	<div class="controls">
        	<label class="control-label"><strong>Experiência Profissional</strong></td>
    	</div>
    </div>

    <div class="control-group">
    	<div class="controls">
        	<label class="control-label"><u>Ultima empresa</u>:</label>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="nomeEmpresa_1" name="nomeEmpresa_1" class="txtMedio" value="<?php echo ($registroCurriculo && $registroCurriculo->NOME_EMPRESA_1 != '') ? utf8_decode($registroCurriculo->NOME_EMPRESA_1) : ''; ?>" /></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<textarea id="atividadeEmpresa_1" name="atividadeEmpresa_1" class="txtGrande"><?php echo ($registroCurriculo && $registroCurriculo->ATIVIDADE_EMPRESA_1 != '') ? utf8_decode($registroCurriculo->ATIVIDADE_EMPRESA_1) : ''; ?></textarea></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="dataAdmissao_1" name="dataAdmissao_1" class="txtPequeno" maxlength="10" value="<?php echo ($registroCurriculo && $registroCurriculo->DATA_ADMISSAO_1 != '') ? Util::formataData($registroCurriculo->DATA_DEMISSAO_1,'-','/') : ''; ?>" />&nbsp;<img src="../admin/bcoOportunidade/imagens/icone-calendario.png" class="imgCalendario" border="0"></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="dataDemissao_1" name="dataDemissao_1" class="txtPequeno" maxlength="10" value="<?php echo ($registroCurriculo && $registroCurriculo->DATA_DEMISSAO_1 != '') ? Util::formataData($registroCurriculo->DATA_DEMISSAO_1,'-','/') : ''; ?>" />&nbsp;<img src="../admin/bcoOportunidade/imagens/icone-calendario.png" class="imgCalendario" border="0"></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="funcaoExercida_1" name="funcaoExercida_1" class="txtMedio" value="<?php echo ($registroCurriculo && $registroCurriculo->FUNCAO_EXERCIDA_1 != '') ? utf8_decode($registroCurriculo->FUNCAO_EXERCIDA_1) : ''; ?>" /></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<textarea id="atividadeExercida_1" name="atividadeExercida_1" class="txtGrande"><?php echo ($registroCurriculo && $registroCurriculo->ATIVIDADE_EXERCIDA_1 != '') ? utf8_decode($registroCurriculo->ATIVIDADE_EXERCIDA_1) : ''; ?></textarea></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="salario_1" name="salario_1" class="txtPequeno" value="<?php echo ($registroCurriculo && $registroCurriculo->SALARIO_1 != '') ? number_format($registroCurriculo->SALARIO_1,2,',','.') : ''; ?>" /></td>
    	</div>
    </div>

    <div class="control-group">
        <label class="control-label"><u>Penúltima empresa</u>:</label>
    </div>

    <div class="control-group">
        <label class="control-label" for="nomeEmpresa_2">Nome da empresa:</label>
        <div class="controls">
        	<input type="text" id="nomeEmpresa_2" name="nomeEmpresa_2" class="txtMedio" value="<?php echo ($registroCurriculo && $registroCurriculo->NOME_EMPRESA_2 != '') ? utf8_decode($registroCurriculo->NOME_EMPRESA_2) : ''; ?>" /></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<textarea id="atividadeEmpresa_2" name="atividadeEmpresa_2" class="txtGrande"><?php echo ($registroCurriculo && $registroCurriculo->ATIVIDADE_EMPRESA_2 != '') ? utf8_decode($registroCurriculo->ATIVIDADE_EMPRESA_2) : ''; ?></textarea></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="dataAdmissao_2" name="dataAdmissao_2" class="txtPequeno" maxlength="10" value="<?php echo ($registroCurriculo && $registroCurriculo->DATA_ADMISSAO_2 != '') ? Util::formataData($registroCurriculo->DATA_ADMISSAO_2,'-','/') : ''; ?>" />&nbsp;<img src="../admin/bcoOportunidade/imagens/icone-calendario.png" class="imgCalendario" border="0"></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="dataDemissao_2" name="dataDemissao_2" class="txtPequeno" maxlength="10" value="<?php echo ($registroCurriculo && $registroCurriculo->DATA_DEMISSAO_2 != '') ? Util::formataData($registroCurriculo->DATA_DEMISSAO_2,'-','/') : ''; ?>" />&nbsp;<img src="../admin/bcoOportunidade/imagens/icone-calendario.png" class="imgCalendario" border="0"></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="funcaoExercida_2" name="funcaoExercida_2" class="txtMedio" value="<?php echo ($registroCurriculo && $registroCurriculo->FUNCAO_EXERCIDA_2 != '') ? utf8_decode($registroCurriculo->FUNCAO_EXERCIDA_2) : ''; ?>" /></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<textarea id="atividadeExercida_2" name="atividadeExercida_2" class="txtGrande"><?php echo ($registroCurriculo && $registroCurriculo->ATIVIDADE_EXERCIDA_2 != '') ? utf8_decode($registroCurriculo->ATIVIDADE_EXERCIDA_2) : ''; ?></textarea></td>
    	</div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
        	<input type="text" id="salario_2" name="salario_2" class="txtPequeno" value="<?php echo ($registroCurriculo && $registroCurriculo->SALARIO_2 != '') ? number_format($registroCurriculo->SALARIO_2,2,',','.') : ''; ?>" /></td>
        </div>
    </div>

    <button type="button" id="btnGravarCurriculo" class="btn btn-primary">Gravar</button>
